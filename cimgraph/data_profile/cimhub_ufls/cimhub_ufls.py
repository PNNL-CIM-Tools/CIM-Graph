...
class AccumulationKind(Enum):
    ...
    :cvar cumulative: The sum of the previous billing period values.
        ...
        “demand.” Each demand reset causes the maximum demand value for
        the present billing period (since the last demand reset) to
    ...
    :cvar indicating: As if a needle is swung out on the meter face to a
        ...
        or may imply a “pusher” mechanism to capture a value. Compare
        this to 'instantaneous' which is measured over a shorter period
        of time.
    ...
    :cvar latchingQuantity: When this description is applied to a
        ...
        in the downward direction – upon reaching a minimum value. The
...
class CommodityKind(Enum):
    ...
    :cvar electricityPrimaryMetered: It is possible for a meter to be
        ...
        that represents the service value is called the “primary
    ...
    :cvar naturalGas:
    :cvar none: Not Applicable
    :cvar nonpotableWater: Reclaimed water – possibly used for
...
class MeasurementKind(Enum):
    ...
    :cvar batteryVoltage:
    :cvar billCarryover: Customer’s bill for the (Currency)
    :cvar billLastPeriod: Customer’s bill for the previous billing
        period (Currency)
    :cvar billToDate: Customer’s bill, as known thus far within the
    ...
    :cvar fan:
    :cvar frequency:
    :cvar frequencyExcursion: Usually expressed as a “count”
    :cvar fund: Dup with “currency”
...
class DERDynamics(DynamicsFunctionBlock):
    ...
    :ivar AsynchronousMachine: Asynchronous machine model with which
        this DER dynamics model is associated.
...
class FunctionInputVariable(IdentifiedObject):
    ...
    :ivar Function: Function block describe the function that function
        input variable provides the domain for.
    """
...
class FunctionOutputVariable(IdentifiedObject):
    ...
    :ivar FunctionBlock: Function block describe the function that
        function output variable provides the codomain for.
    """
...
class PhaseTapChangerTable(IdentifiedObject):
    ...
    PhaseTapChangerTabular: List[object] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://iec.ch/TC57/CIM100#",
...
class FunctionBlock(IdentifiedObject):
    """Function block is a function described as a set of elementary blocks.

    The blocks describe the function between input variables and output
    variables.

    :ivar enabled: True, if the function block is enabled (active).
        Otherwise false.
    :ivar priority: Value 0 means ignore priority. 1 means the highest
        priority, 2 is the second highest priority.
    :ivar FunctionOutputVariable: Function output variable describe the
        output or codomain to the function block.
    :ivar Input: Function input variable describe the input or domain to
        the function block.
    """
    enabled: Optional[bool] = field(
        default=None,
...
class ProtectionEquipment(Equipment):
    ...
    or simply to display the detected condition.

    Protection equipment is associated with conducting equipment and
    usually operate circuit breakers.

    :ivar highLimit: The maximum allowable value.
    :ivar lowLimit: The minimum allowable value.
    :ivar powerDirectionFlag: Direction same as positive active power
        flow value.
    :ivar relayDelayTime: The time delay from detection of abnormal
        conditions to relay operation.
    :ivar unitMultiplier: The unit multiplier of the value.
    :ivar unitSymbol: The unit of measure of the value.
    :ivar ProtectedSwitches: Protected switches operated by this
        ProtectionEquipment.
    :ivar ProtectionFunctionBlock:
    """
    ...
    relayDelayTime: Optional[float] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://iec.ch/TC57/CIM100#",
...
class ProtectionFunctionBlock(FunctionBlock):
    ...
    operateDelayTime: Optional[float] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://iec.ch/TC57/CIM100#",
    ...
    operateTime: Optional[float] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://iec.ch/TC57/CIM100#",
    ...
    resetDelayTime: Optional[float] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://iec.ch/TC57/CIM100#",
    ...
    resetTime: Optional[float] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://iec.ch/TC57/CIM100#",
...
class FrequencyProtectionFunctionBlock(WideAreaProtectionFunctionBlock):
    voltageBlockValue: Optional[float] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://iec.ch/TC57/CIM100#",
