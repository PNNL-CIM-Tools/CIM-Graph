...
'''
Annotated CIMantic Graphs data profile for cimhub_2026
...
class BundleConfiguration(AssetInfo):
    ...
    conductorSpacing: Optional[ float | Displacement ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
...
class WireInfo(ConductorInfo):
    ...
    WireBundleInfo: list[BundleConfiguration] = field(
        default_factory=list,
        metadata={
        'type': 'Association',
        'stereotypes': [],
...
class ConductorDistance(AssetInfo):
    ...
    fromSequenceNumber: Optional[int] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
    ...
    toSequenceNumber: Optional[int] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
...
class BatteryInfo(DCConductingAssetInfo):
    ...
    usableCapacity: Optional[ float | RealEnergy ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
...
class LoadArea(EnergyArea):
    ...
    peakLoad: Optional[ float | ActivePower ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
...
class Analog(Measurement):
    ...
    PointOnWaveValues: list[PointOnWaveValue] = field(
        default_factory=list,
        metadata={
        'type': 'Association',
        'stereotypes': [],
...
class AreaDispatchableUnit(PowerSystemResource):
    ...
    @property
    def __namespace__(self):
        return 'http://entsoe.eu/ns/nc#'
    @property
    def __package__(self):
        return 'ExtPowerShiftKey'
    @property
    def __minOccurs__(self):
        return '0'
    @property
...
class CommunicationLink(PowerSystemResource):
    ...
    Sensors: list[MeasurementSystem] = field(
        default_factory=list,
        metadata={
        'type': 'Association',
        'stereotypes': [],
...
class ConnectivityArea(EquipmentContainer):
    '''
    A persistent connectivity-based containment of Equipment with clearly defined
    electrical boundaries based on terminals of boundary equipment in a transmission
    or distribution network.
    In a transmission context, this class provides a persistent superset grouping
    of equipment across multiple substations to describe an operating area
    of responsibility or bounded area for simulation studies.
    In a distribution context, this class differs from Feeder (which is largely
    for naming purposes) by providing groupings of equipment on the basis of
    connectivity.
    '''
    ...
    contained (e.g. distribution area that contains a feeder area)
    '''

    ContainedAreas: list[ConnectivityArea] = field(
        default_factory=list,
        metadata={
        'type': 'Association',
        'stereotypes': [],
    ...
    (e.g. the set of feeder areas contained within a distribution area)
    '''
...
class ACLineSegment(Conductor):
    ...
    circuitNumber: Optional[int] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
...
class LinearShuntCompensator(ShuntCompensator):
    ...
    rPerSection: Optional[ float | Resistance ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
    ...
    xPerSection: Optional[ float | Reactance ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
...
class Switch(ConductingEquipment):
    ...
    areas, such as across a transmission-distribution boundary
    '''
...
class PowerTransferCorridor(PowerSystemResource):
    ...
    @property
    def __package__(self):
        return 'ExtPowerTransferCorridor'
    @property
    def __minOccurs__(self):
        return '0'
    @property
...
class LinearShuntCompensatorPhase(ShuntCompensatorPhase):
    ...
    strayInductancePerSection: Optional[ float | Inductance ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
...
class StateShortCircuitResult(IdentifiedObject):
    ...
    @property
    def __namespace__(self):
        return 'http://GB/placeholder/ext#'
    @property
    def __package__(self):
        return 'ExtGBShortCircuit'
    @property
    def __minOccurs__(self):
        return '0'
    @property
...
class PMUConfigurationFrame(SynchrophaserFrame):
    ...
    the PMU data transmission rate given by PhasorMeasurementUnit.reportingUnit
    in Table 18 of IEEE Std. C37.118. It shall also be large enough to
    support the time resolution required for the discrete event data frames
    '''
...
class TopologicalArea(IdentifiedObject):
    '''
    Topological grouping of connectivity areas based on current status of switch
    positions
    '''
...
class PMUValueQuality(MeasurementValueQuality):
    ...
    0 = Normal data.
    1 = Do not use.
    PMU data is included in the data frame, but PDC�s ask users to not
    use it.
    '''

    dataError: Optional[bool] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
    ...
    insertedData: Optional[bool] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
    ...
    localTimeStamp: Optional[bool] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
...
@stereotype(CIMStereotype.GridAPPSD)
@dataclass(repr=False)
class ResourceContainer(Identity):
    '''
    '''
    ...
    ContainedResources: list[PowerSystemResource] = field(
        default_factory=list,
        metadata={
        'type': 'Association',
        'stereotypes': [],
...
class ConductorDistanceSpacing(WireSpacing):
    ...
    ConductorDistance: list[ConductorDistance] = field(
        default_factory=list,
        metadata={
        'type': 'Association',
        'stereotypes': [],
...
class EquivalentDistanceSpacing(WireSpacing):
    ...
    averageNeutralHeight: Optional[ float | Length ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
    ...
    averagePhaseHeight: Optional[ float | Length ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
    ...
    phaseToNeutralGMD: Optional[ float | Length ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
    ...
    phaseToPhaseGMD: Optional[ float | Length ] = field(
        default=None,
        metadata={
        'type': 'Attribute',
        'stereotypes': ['Attribute'],
...
@stereotype(CIMStereotype.enumeration)
@stereotype(CIMStereotype.Attribute)
class CommunicationMediumKind(Enum):
    '''
    '''
...
@stereotype(CIMStereotype.enumeration)
@stereotype(CIMStereotype.Attribute)
class CommunicationProtocolKind(Enum):
    '''
    '''
...
@stereotype(CIMStereotype.enumeration)
@stereotype(CIMStereotype.Attribute)
class ConnectivityAreaKind(Enum):
    '''
    '''

    distributionArea = 'distributionArea'
    '''
    A topologically continuous grouping of distribution feeders, typically
    divided by normal-open switches. The DistributionArea provides the
    highest-level description of the equipment controlled by the Distribution
    System Operator (DSO)
    '''

    feederArea = 'feederArea'
    '''
    The FeederArea contains all medium voltage equipment not contained
    in a SwitchArea or Substation / Bay. It also includes all Sectionalisers,
    Reclosers, and all other poletop and pad-mounted switchgear that form
    the boundary of a SwitchArea. It also includes all equipment between
    the feeder head terminal and the first switching device if the substation
    breaker is not included in Feeder EquipmentContainer
    '''

    microgrid = 'microgrid'
    '''
    Containment of distribution equipment that 1) has clearly-defined electrical
    boundaries formed by one or more point of common coupling Switch objects
    and 2) that acts as a single controllable entity which can be operated
    in grid-connected or islanded mode. This covers both utility-owned
    distribution microgrids and customer-owned facility microgrids as defined
    in IEV 617-04-22.
    '''

    secondaryArea = 'secondaryArea'
    '''
    Containment of low-voltage distribution Equipment and customer-owned
    Equipment with clearly defined electrical boundaries formed by the
    low-side terminal(s) of one or more PowerTransformer objects.
    '''

    switchArea = 'switchArea'
    '''
    Containment of medium-voltage distribution Equipment with clearly defined
    electrical boundaries formed by one or more Switch objects. The SwitchArea
    contains all conductors, fuses, poletop equipment, and vault equipment.
    It also contains all secondary service transformers not contained in
    a SecondarySubstation.
    '''

    transmissionArea = 'transmissionArea'
    '''
    The connectivity-based grouping of equipment forming a transmission
    system operator's area of responsibility
    '''
...
@stereotype(CIMStereotype.ToBeDeleted)
@stereotype(CIMStereotype.enumeration)
@stereotype(CIMStereotype.Attribute)
...
@stereotype(CIMStereotype.enumeration)
@stereotype(CIMStereotype.Attribute)
class TopologicalAreaKind(Enum):
    '''
    ...
    loop = 'loop'
    '''
    Topological loop through a distribution circuit. May be created with
    an abnormal switching configuration.
    '''

    meshed = 'meshed'
    '''
    Meshed topology found within transmission networks and urban low-voltage
    meshed networks.
    '''

    radial = 'radial'
    '''
    Topologically radial area
    '''
...
@stereotype(CIMStereotype.enumeration)
@stereotype(CIMStereotype.Attribute)
class TopologicalUsageKind(Enum):
    '''
    ...
    acrossDistributionArea = 'acrossDistributionArea'
    '''
    Denotes a tie switch (often normally-open) between two feeders served
    by different Normal Energizing Substation. Closing this switch could
    create a medium-voltage loop between transmission Topological Nodes.
    '''

    acrossFeederArea = 'acrossFeederArea'
    '''
    Denotes a tie switch (often normally-open) between two feeders served
    by the same Normal Energizing Substation
    '''

    acrossSwitchArea = 'acrossSwitchArea'
    '''
    Denotes recloser or sectionaliser used to divide a feeder into switch
    areas
    '''

    acrossTDInterface = 'acrossTDInterface'
    '''
    Denotes a boundary switch across a transmission-distribution interface.
    The switch may have multiple ownerships and may require consensus between
    entities to open/close.
    '''

    acrossTransmissionArea = 'acrossTransmissionArea'
    '''
    Denotes a switch serving as an ownership boundary between two transmission
    areas of responsibility. The switch may have multiple ownerships and
    may require consensus between entities to open/close.
    '''

    busTie = 'busTie'
    '''
    Denotes a bus tie switch in a transmission substation. May require
    Switch.Retained be set to True.
    '''

    bypass = 'bypass'
    '''
    Denotes a bypass switch in a transmission substation, either for maintenance
    or to bypass a SeriesCompensator. May require Switch.Retained be set
    to True.
    '''
