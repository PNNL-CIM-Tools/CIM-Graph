...
from cimgraph.databases import JSONLDFile
from cimgraph.models import FeederModel
from cimgraph.queries import sparql


class TestJSONLDFile(unittest.TestCase):
    ...
    def test_jsonld_connection_with_env_vars(self):

        connection = JSONLDFile(filename='tests/test_models/ieee13.jsonld')
        self.assertIsInstance(connection, JSONLDFile, 'Connection should be an instance of JSONLDFile')
    ...
    def test_get_feeder_model(self):
        database = JSONLDFile(filename='tests/test_models/ieee13.jsonld')
